...
const DoughnutChart = () => {
    ...
    return (
        <Card>
            <CardHeader 
                title='As 5 criptomoedas mais baratas' 
                subheader='Top 5 criptomoedas mais baratas acima de US $ 100 medidas pelo seu preço de mercado' 
            />
            <Divider />
            <CardContent>
                <Box sx={{ height: 477, position: 'relative' }}>
                    <Pie
                        data={data} 
                        options={options} 
